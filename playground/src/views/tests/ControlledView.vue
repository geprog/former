  ...
  <div class="w-screen h-screen bg-white p-8 flex justify-center items-center" vaul-drawer-wrapper="">
    <DrawerRoot :open="open">
      ...
      <DrawerPortal>
        ...
        >
          ...
          <button data-testid="controlled-close" class="text-2xl" @click="open = false">Close</button>
    ...
    <DrawerRoot v-model:open="fullyControlled">
      ...
      <DrawerPortal>
        ...
        >
          <DrawerClose data-testid="drawer-close"> Close </DrawerClose>
          <button data-testid="controlled-close" class="text-2xl" @click="fullyControlled = false">Close</button>
          <div class="p-4 bg-white rounded-t-[10px] flex-1">
            <div class="mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-zinc-300 mb-8" />
            <div class="max-w-md mx-auto">
              <DrawerTitle class="font-medium mb-4"> Unstyled drawer for Vue. </DrawerTitle>

<template>
  <div
    ...
    :class="{ 'former-drag-container min-h-24 w-full border-2 p-2 border-dashed rounded-md border-zinc-200 empty:before:block empty:bg-zinc-100 empty:dark:bg-zinc-800': mode === 'build' }"
